...
import BgandTtlpattern1 from '@/components/bgandttlpattern/BgandTtlpattern1';
import BgandTtlpattern2 from '@/components/bgandttlpattern/BgandTtlpattern2';

const sectionComponents: Section[] = [
  { id: 'bgandttlpattern1', component: BgandTtlpattern1 },
  { id: 'bgandttlpattern2', component: BgandTtlpattern2 },
];
