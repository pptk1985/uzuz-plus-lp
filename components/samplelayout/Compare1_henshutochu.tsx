        ...
        <Table className="rounded border text-left shadow-lg">
          ...
          <TableBody className="text-foreground">
            ...
            <TableRow>
              ...
              <TableCell className="px-6 py-4">Requires extra setup</TableCell>
            </TableRow>
            {/* <TableRow>
              <TableCell className="px-6 py-4">TypeScript Support</TableCell>
              <TableCell className="bg-muted px-6 py-4">First-class</TableCell>
              ...
              <TableCell className="relative px-6 py-4">
                <Tooltip>
                  ...
                  <TooltipContent sideOffset={8} className="max-w-xs">
                    ...
                    Some advanced components are only available in paid versions
                    or require third-party libraries.
                  </TooltipContent>
                </Tooltip>
              </TableCell>
            </TableRow>
