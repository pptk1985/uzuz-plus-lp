    ...
    >
      <div className="flex justify-center items-center h-full max-w-6xl mx-auto">
        <div className="grid grid-cols-1 gap-4 justify-center items-center w-full h-full">
          <div className="border h-full flex justify-center items-center relative">
            {/* 左上の角の画像 */}
            <div className="absolute -top-6 -left-1 w-20 h-20 sm:w-30 sm:h-30 -rotate-12">
              <img
                src={CornerImg.src}
                alt="Corner Image"
            ...
            {/* 右上の角の画像 */}
            <div className="absolute -top-6 -right-1 w-20 h-20 sm:w-30 sm:h-30 rotate-12">
              <img
                src={CornerImg.src}
                alt="Corner Image"
                className="w-full h-full object-contain"
            ...
            {/* 左下の角の画像 */}
            <div className="absolute -bottom-6 -left-1 w-20 h-20 sm:w-30 sm:h-30 rotate-12">
              <img
                src={CornerImg.src}
                alt="Corner Image"
                className="w-full h-full object-contain"
            ...
            {/* 右下の角の画像 */}
            <div className="absolute -bottom-6 -right-1 w-20 h-20 sm:w-30 sm:h-30 -rotate-12">
              <img
                src={CornerImg.src}
                alt="Corner Image"
                className="w-full h-full object-contain"
